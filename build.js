...
var App = function() {
	...
	this.wallStock = Wall.createWalls(this.display);
};
App.prototype = {
	...
	,drawWall: function(w) {
		this.display.setPixel(w.position,w.name);
		return w;
	}
	...
	,update: function() {
		...
		while(_g < _g1.length) {
			...
			if(e.health > 0) {
				...
				var _g2 = 0;
				var _g3 = this.wallStock;
				while(_g2 < _g3.length) {
					var v = _g3[_g2];
					++_g2;
					if(this.isEqual(e,v) == true) {
						e.position.x -= random1;
						e.position.y -= random2;
					}
					this.drawWall(v);
...
var Wall = function(name,position) {
	this.name = name;
	this.position = position;
};
Wall.createWalls = function(display) {
	var count = 0;
	var wallStock = [];
	while(count < 10) {
